...
class Handler extends ExceptionHandler
{
    ...
    public function register(): void
    {
        ...
        $this->renderable(function (\Spatie\Permission\Exceptions\UnauthorizedException $exception){
            return \response()->json(['success'=>false,'message'=>$exception->getMessage(),'code'=>403],403) ;
        });

        $this->renderable(function (\Symfony\Component\HttpKernel\Exception\MethodNotAllowedHttpException $exception){
